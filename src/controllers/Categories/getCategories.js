...
exports.getCategoriesAdmin = exports.getCategories = void 0;
...
const getCategoriesAdmin = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield Categories_1.default.allCategories();
        if (data.length === 0) {
            return res.json({
                status: 202,
                message: 'No Data'
