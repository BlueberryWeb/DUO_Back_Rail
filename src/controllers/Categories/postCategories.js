...
const AddCategories = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const body = Object.assign(Object.assign({}, req.body), { id_user: '6596f137294f73a7574d4b5c' });
        const Category = yield new Categories_1.default(body).save();
        const Category_Push = yield Category.populate('id_user');
        const data = [{
